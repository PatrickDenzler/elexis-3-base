...
public class Messages{
    ...
    public static String MiGelDetailDisplay_Price = ch.elexis.core.l10n.Messages.MiGelDetailDisplay_Price;
    public static String MiGelDetailDisplay_Unit = ch.elexis.core.l10n.Messages.MiGelDetailDisplay_Unit;

...
public class Messages{
    ...
    public static String NotesDetail_couldNotLaunch = ch.elexis.core.l10n.Messages.NotesDetail_couldNotLaunch;
    public static String NotesDetail_deleteActionCaption = ch.elexis.core.l10n.Messages.NotesDetail_deleteActionCaption;
    public static String NotesDetail_deleteActionToolTip = ch.elexis.core.l10n.Messages.NotesDetail_deleteActionToolTip;
    public static String NotesDetail_deleteConfirmCaption = ch.elexis.core.l10n.Messages.NotesDetail_deleteConfirmCaption;
    public static String NotesDetail_deleteConfirmMessage = ch.elexis.core.l10n.Messages.NotesDetail_deleteConfirmMessage;
    public static String NotesDetail_newActionCaption = ch.elexis.core.l10n.Messages.NotesDetail_newActionCaption;
    ...
    public static String NotesView_deleteActionCaption = ch.elexis.core.l10n.Messages.NotesView_deleteActionCaption;
    ...
    public static String NotesView_importErrorDlgTitle = ch.elexis.core.l10n.Messages.NotesView_importErrorDlgTitle;
    public static String NotesView_importErrorTitle = ch.elexis.core.l10n.Messages.NotesView_importErrorTitle;
    public static String NotesView_newCategory = ch.elexis.core.l10n.Messages.NotesView_newCategory;
    ...
    public static String Preferences_basedir = ch.elexis.core.l10n.Messages.Preferences_basedir;

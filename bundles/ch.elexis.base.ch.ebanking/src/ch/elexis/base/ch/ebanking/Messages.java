...
public class Messages{
    ...
    public static String ESRRecordDialog_addedDate = ch.elexis.core.l10n.Messages.ESRRecordDialog_addedDate;
    ...
    public static String ESRRecordDialog_patient = ch.elexis.core.l10n.Messages.ESRRecordDialog_patient;
    ...
    public static String ESRRecordDialog_readInDate = ch.elexis.core.l10n.Messages.ESRRecordDialog_readInDate;
    public static String ESRRecordDialog_receivedDate = ch.elexis.core.l10n.Messages.ESRRecordDialog_receivedDate;
    public static String ESRRecordDialog_selectPatient = ch.elexis.core.l10n.Messages.ESRRecordDialog_selectPatient;
    public static String ESRRecordDialog_stornoESR = ch.elexis.core.l10n.Messages.ESRRecordDialog_stornoESR;
    public static String ESRRecordDialog_vESRForBill = ch.elexis.core.l10n.Messages.ESRRecordDialog_vESRForBill;
    public static String ESRRecordDialog_warningEditing = ch.elexis.core.l10n.Messages.ESRRecordDialog_warningEditing;
    public static String ESRView2_accountedDate = ch.elexis.core.l10n.Messages.ESRView2_accountedDate;
    public static String ESRView2_addedDate = ch.elexis.core.l10n.Messages.ESRView2_addedDate;
    ...
    public static String ESRView2_file = ch.elexis.core.l10n.Messages.ESRView2_file;
    public static String ESRView2_loadingESR = ch.elexis.core.l10n.Messages.ESRView2_loadingESR;
    public static String ESRView2_notbooked = ch.elexis.core.l10n.Messages.ESRView2_notbooked;
    public static String ESRView2_patient = ch.elexis.core.l10n.Messages.ESRView2_patient;
    public static String ESRView2_readDate = ch.elexis.core.l10n.Messages.ESRView2_readDate;
    ...
    public static String ESRView_errorESR2 = ch.elexis.core.l10n.Messages.ESRView_errorESR2;
    public static String ESRView_errrorESR2 = ch.elexis.core.l10n.Messages.ESRView_errrorESR2;
    ...
    public static String ESRView_loadESR = ch.elexis.core.l10n.Messages.ESRView_loadESR;
    ...
    public static String ESRView_vesrfor = ch.elexis.core.l10n.Messages.ESRView_vesrfor;

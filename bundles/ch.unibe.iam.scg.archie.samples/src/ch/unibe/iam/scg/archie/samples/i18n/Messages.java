...
public final class Messages extends NLS {
	...
	public static String USER_OVERVIEW_USER = ch.elexis.core.l10n.Messages.USER_OVERVIEW_USER;
	...
	public static String USER_OVERVIEW_GROUPS = ch.elexis.core.l10n.Messages.USER_OVERVIEW_GROUPS;
	public static String USER_OVERVIEW_YES = ch.elexis.core.l10n.Messages.USER_OVERVIEW_YES;
	public static String USER_OVERVIEW_NO = ch.elexis.core.l10n.Messages.USER_OVERVIEW_NO;
	public static String USER_OVERVIEW_UNDEFINED = ch.elexis.core.l10n.Messages.USER_OVERVIEW_UNDEFINED;
	public static String CONSULTATION_STATS_TITLE = ch.elexis.core.l10n.Messages.CONSULTATION_STATS_TITLE;
	...
	public static String CONSULTATION_STATS_NUMBER_OF_CONSULTATIONS = ch.elexis.core.l10n.Messages.CONSULTATION_STATS_NUMBER_OF_CONSULTATIONS;
	...
	public static String CONSULTATION_TIME_STATS_HEADING_INCOME = ch.elexis.core.l10n.Messages.CONSULTATION_TIME_STATS_HEADING_INCOME;
	public static String CONSULTATION_TIME_STATS_HEADING_SPENDING = ch.elexis.core.l10n.Messages.CONSULTATION_TIME_STATS_HEADING_SPENDING;
	public static String CONSULTATION_TIME_STATS_HEADING_PROFIT = ch.elexis.core.l10n.Messages.CONSULTATION_TIME_STATS_HEADING_PROFIT;
	...
	public static String PATIENTS_PROFITS_HEADING_PATIENT = ch.elexis.core.l10n.Messages.PATIENTS_PROFITS_HEADING_PATIENT;
	public static String PATIENTS_PROFITS_HEADING_COSTS = ch.elexis.core.l10n.Messages.PATIENTS_PROFITS_HEADING_COSTS;
	public static String PATIENTS_PROFITS_HEADING_INCOME = ch.elexis.core.l10n.Messages.PATIENTS_PROFITS_HEADING_INCOME;
	public static String PATIENTS_PROFITS_HEADING_PROFIT = ch.elexis.core.l10n.Messages.PATIENTS_PROFITS_HEADING_PROFIT;
	...
	public static String PRESCRIPTIONS_OVERVIEW_HEADING_NAME = ch.elexis.core.l10n.Messages.PRESCRIPTIONS_OVERVIEW_HEADING_NAME;
	...
	public static String SERVICES_TITLE = ch.elexis.core.l10n.Messages.SERVICES_TITLE;
	public static String SERVICES_DESCRIPTION = ch.elexis.core.l10n.Messages.SERVICES_DESCRIPTION;
	public static String SERVICES_HEADING_CODESYSTEM = ch.elexis.core.l10n.Messages.SERVICES_HEADING_CODESYSTEM;
	...
	public static String SERVICES_HEADING_COSTS = ch.elexis.core.l10n.Messages.SERVICES_HEADING_COSTS;
	public static String SERVICES_HEADING_INCOME = ch.elexis.core.l10n.Messages.SERVICES_HEADING_INCOME;
	public static String SERVICES_HEADING_PROFITS = ch.elexis.core.l10n.Messages.SERVICES_HEADING_PROFITS;
	public static String DIAGNOSES_TITLE = ch.elexis.core.l10n.Messages.DIAGNOSES_TITLE;

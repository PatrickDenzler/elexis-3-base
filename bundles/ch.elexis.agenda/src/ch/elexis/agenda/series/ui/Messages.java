...
public class Messages{
  public static final String BUNDLE_NAME = "ch.elexis.agenda.series.ui.messages";
    ...
    public static String SerienTerminDialog_grpTermin_text = ch.elexis.core.l10n.Messages.SerienTerminDialog_grpTermin_text;
    ...
    public static String SerienTerminDialog_txtContact_message = ch.elexis.core.l10n.Messages.SerienTerminDialog_txtContact_message;
    public static String SerienTerminDialog_txtReason_message = ch.elexis.core.l10n.Messages.SerienTerminDialog_txtReason_message;
    ...
    public static String YearlySeriesComposite_lblAtThe_text = ch.elexis.core.l10n.Messages.YearlySeriesComposite_lblAtThe_text;
    public static String SerienTermin_friday = ch.elexis.core.l10n.Messages.SerienTermin_friday;
    public static String SerienTermin_monday = ch.elexis.core.l10n.Messages.SerienTermin_monday;
    public static String SerienTermin_saturday = ch.elexis.core.l10n.Messages.SerienTermin_saturday;
    public static String SerienTermin_sunday = ch.elexis.core.l10n.Messages.SerienTermin_sunday;

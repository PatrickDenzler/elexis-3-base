...
public final class Messages extends NLS {
	...
	public static String TagesView_previousDay = ch.elexis.core.l10n.Messages.TagesView_previousDay;
	public static String TagesView_selectDay = ch.elexis.core.l10n.Messages.TagesView_selectDay;
	public static String TagesView_nextDay = ch.elexis.core.l10n.Messages.TagesView_nextDay;
	public static String TagesView_printDay = ch.elexis.core.l10n.Messages.TagesView_printDay;
	public static String TagesView_14 = ch.elexis.core.l10n.Messages.TagesView_14;
	...
	public static String TagesView_newWindow = ch.elexis.core.l10n.Messages.TagesView_newWindow;
	...
	public static String TagesView_praxis = ch.elexis.core.l10n.Messages.TagesView_praxis;
	...
	public static String Termin_no = ch.elexis.core.l10n.Messages.Termin_no;
	public static String Termin_normal = ch.elexis.core.l10n.Messages.Termin_normal;
	public static String Termin_normalAppointment = ch.elexis.core.l10n.Messages.Termin_normalAppointment;
	public static String Termin_plannedAppointment = ch.elexis.core.l10n.Messages.Termin_plannedAppointment;
	public static String Termin_plannedHereFinishedMissed = ch.elexis.core.l10n.Messages.Termin_plannedHereFinishedMissed;
	public static String Termin_range_free = ch.elexis.core.l10n.Messages.Termin_range_free;
	public static String Termin_range_locked = ch.elexis.core.l10n.Messages.Termin_range_locked;
	...
	public static String Termin_yes = ch.elexis.core.l10n.Messages.Termin_yes;
	...
	public static String TerminDialog_locked = ch.elexis.core.l10n.Messages.TerminDialog_locked;
	...
	public static String TerminDialog_change = ch.elexis.core.l10n.Messages.TerminDialog_change;
	...
	public static String TerminDialog_find = ch.elexis.core.l10n.Messages.TerminDialog_find;
	...
	public static String TerminStatusDialog_terminState = ch.elexis.core.l10n.Messages.TerminStatusDialog_terminState;
	...
	public static String TerminDialog_typeandstate = ch.elexis.core.l10n.Messages.TerminDialog_typeandstate;
	public static String TerminDialog_reason = ch.elexis.core.l10n.Messages.TerminDialog_reason;
	public static String TerminDialog_32 = ch.elexis.core.l10n.Messages.TerminDialog_32;
	public static String TerminDialog_editTermins = ch.elexis.core.l10n.Messages.TerminDialog_editTermins;
	public static String TerminDialog_collision = ch.elexis.core.l10n.Messages.TerminDialog_collision;
	public static String TerminDialog_termin = ch.elexis.core.l10n.Messages.TerminDialog_termin;
	public static String TerminDialog_noPatSelected = ch.elexis.core.l10n.Messages.TerminDialog_noPatSelected;
	public static String TerminDialog_40 = ch.elexis.core.l10n.Messages.TerminDialog_40;
	...
	public static String TerminDialog_print = ch.elexis.core.l10n.Messages.TerminDialog_print;
	...
	public static String AgendaDefinitionen_states = ch.elexis.core.l10n.Messages.AgendaDefinitionen_states;
	...
	public static String AgendaImages_change = ch.elexis.core.l10n.Messages.AgendaImages_change;
	...
	public static String Tageseinteilung_praxis = ch.elexis.core.l10n.Messages.Tageseinteilung_praxis;
	public static String Tageseinteilung_enterPeriods = ch.elexis.core.l10n.Messages.Tageseinteilung_enterPeriods;
	public static String Tageseinteilung_mo = ch.elexis.core.l10n.Messages.Tageseinteilung_mo;
	public static String Tageseinteilung_tu = ch.elexis.core.l10n.Messages.Tageseinteilung_tu;
	public static String Tageseinteilung_we = ch.elexis.core.l10n.Messages.Tageseinteilung_we;
	public static String Tageseinteilung_th = ch.elexis.core.l10n.Messages.Tageseinteilung_th;
	public static String Tageseinteilung_fr = ch.elexis.core.l10n.Messages.Tageseinteilung_fr;
	public static String Tageseinteilung_sa = ch.elexis.core.l10n.Messages.Tageseinteilung_sa;
	public static String Tageseinteilung_so = ch.elexis.core.l10n.Messages.Tageseinteilung_so;
	public static String Tageseinteilung_su = ch.elexis.core.l10n.Messages.Tageseinteilung_su;
	public static String Zeitvorgaben_timePrefs = ch.elexis.core.l10n.Messages.Zeitvorgaben_timePrefs;
	public static String Zeitvorgaben_praxis = ch.elexis.core.l10n.Messages.Zeitvorgaben_praxis;
	...
	public static String AgendaGross_newWindow = ch.elexis.core.l10n.Messages.AgendaGross_newWindow;
	public static String AgendaGross_today = ch.elexis.core.l10n.Messages.AgendaGross_today;
	public static String BaseAgendaView_dayLimits = ch.elexis.core.l10n.Messages.BaseAgendaView_dayLimits;
	public static String BaseAgendaView_errorHappendPrinting = ch.elexis.core.l10n.Messages.BaseAgendaView_errorHappendPrinting;
	public static String BaseAgendaView_errorWhileprinting = ch.elexis.core.l10n.Messages.BaseAgendaView_errorWhileprinting;
	public static String BaseAgendaView_exportAgenda = ch.elexis.core.l10n.Messages.BaseAgendaView_exportAgenda;
	public static String BaseAgendaView_exportAppointsments = ch.elexis.core.l10n.Messages.BaseAgendaView_exportAppointsments;
	public static String BaseAgendaView_importAgenda = ch.elexis.core.l10n.Messages.BaseAgendaView_importAgenda;
	public static String BaseAgendaView_importFromIcal = ch.elexis.core.l10n.Messages.BaseAgendaView_importFromIcal;
	public static String BaseAgendaView_printDayList = ch.elexis.core.l10n.Messages.BaseAgendaView_printDayList;
	public static String BaseAgendaView_printFutureAppsOfSelectedPatient = ch.elexis.core.l10n.Messages.BaseAgendaView_printFutureAppsOfSelectedPatient;
	public static String BaseAgendaView_printListOfDay = ch.elexis.core.l10n.Messages.BaseAgendaView_printListOfDay;
	public static String BaseAgendaView_printPatAppointments = ch.elexis.core.l10n.Messages.BaseAgendaView_printPatAppointments;
	public static String BaseView_dayLimits = ch.elexis.core.l10n.Messages.BaseView_dayLimits;
	
	public static String BaseView_errorHappendPrinting = ch.elexis.core.l10n.Messages.BaseView_errorHappendPrinting;
	public static String BaseView_errorWhilePrinting = ch.elexis.core.l10n.Messages.BaseView_errorWhilePrinting;
	public static String BaseView_exportAgenda = ch.elexis.core.l10n.Messages.BaseView_exportAgenda;
	public static String BaseView_exportAppojntmentsOfMandator = ch.elexis.core.l10n.Messages.BaseView_exportAppojntmentsOfMandator;
	public static String BaseView_importAgenda = ch.elexis.core.l10n.Messages.BaseView_importAgenda;
	public static String BaseView_importFromICal = ch.elexis.core.l10n.Messages.BaseView_importFromICal;
	public static String BaseView_printAppointments = ch.elexis.core.l10n.Messages.BaseView_printAppointments;
	public static String BaseView_printAPpointmentsOfSelectedDay = ch.elexis.core.l10n.Messages.BaseView_printAPpointmentsOfSelectedDay;
	public static String BaseView_printDayPaapintments = ch.elexis.core.l10n.Messages.BaseView_printDayPaapintments;
	public static String BaseView_printFutureAppointmentsOfSelectedPatient = ch.elexis.core.l10n.Messages.BaseView_printFutureAppointmentsOfSelectedPatient;
	public static String BaseView_showToday = ch.elexis.core.l10n.Messages.BaseView_showToday;
	public static String BaseView_today = ch.elexis.core.l10n.Messages.BaseView_today;
	...
	public static String ICalTransfer_couldNotWriteFile = ch.elexis.core.l10n.Messages.ICalTransfer_couldNotWriteFile;
	public static String ICalTransfer_csvFIles = ch.elexis.core.l10n.Messages.ICalTransfer_csvFIles;
	public static String ICalTransfer_exportAgenda = ch.elexis.core.l10n.Messages.ICalTransfer_exportAgenda;
	public static String ICalTransfer_exportAgendaMandator = ch.elexis.core.l10n.Messages.ICalTransfer_exportAgendaMandator;
	public static String ICalTransfer_file = ch.elexis.core.l10n.Messages.ICalTransfer_file;
	public static String ICalTransfer_fileToImport = ch.elexis.core.l10n.Messages.ICalTransfer_fileToImport;
	public static String ICalTransfer_from = ch.elexis.core.l10n.Messages.ICalTransfer_from;
	...
	public static String ICalTransfer_importAppointments = ch.elexis.core.l10n.Messages.ICalTransfer_importAppointments;
	...
	public static String ICalTransfer_readError = ch.elexis.core.l10n.Messages.ICalTransfer_readError;
	...
	public static String Tageseinteilung_lblDaysStartAt_text = ch.elexis.core.l10n.Messages.Tageseinteilung_lblDaysStartAt_text;
	public static String Tageseinteilung_btnDaysStartAt_text = ch.elexis.core.l10n.Messages.Tageseinteilung_btnDaysStartAt_text;
	...
	public static String Tageseinteilung_lblHours_text = ch.elexis.core.l10n.Messages.Tageseinteilung_lblHours_text;
	...
	public static String Tageseinteilung_lblHours_1_text = ch.elexis.core.l10n.Messages.Tageseinteilung_lblHours_1_text;

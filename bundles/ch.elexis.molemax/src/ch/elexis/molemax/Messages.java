...
public class Messages{
    ...
    public static String AllSlotsDisplay_right = ch.elexis.core.l10n.Messages.AllSlotsDisplay_right;
    ...
    public static String ImageSlot_delete = ch.elexis.core.l10n.Messages.ImageSlot_delete;
    ...
    public static String MolemaxPrefs_basedir = ch.elexis.core.l10n.Messages.MolemaxPrefs_basedir;
    public static String Overview_baseDate = ch.elexis.core.l10n.Messages.Overview_baseDate;
    public static String Overview_noPatient = ch.elexis.core.l10n.Messages.Overview_noPatient;

...
public class Messages{
    ...
    public static String Handler_errorMessageNoPatientSelected = ch.elexis.core.l10n.Messages.Handler_errorMessageNoPatientSelected;
    public static String Handler_errorTitleNoPatientSelected = ch.elexis.core.l10n.Messages.Handler_errorTitleNoPatientSelected;

...
public class Messages{
    ...
    public static String DocHandle_documentErrorCaption = ch.elexis.core.l10n.Messages.DocHandle_documentErrorCaption;
    public static String DocHandle_documentErrorText1 = ch.elexis.core.l10n.Messages.DocHandle_documentErrorText1;
    public static String DocHandle_documentErrorText2 = ch.elexis.core.l10n.Messages.DocHandle_documentErrorText2;
    public static String DocHandle_execErrorCaption = ch.elexis.core.l10n.Messages.DocHandle_execErrorCaption;
    public static String DocHandle_importErrorCaption = ch.elexis.core.l10n.Messages.DocHandle_importErrorCaption;
    public static String DocHandle_importErrorText1 = ch.elexis.core.l10n.Messages.DocHandle_importErrorText1;
    public static String DocHandle_importErrorText2 = ch.elexis.core.l10n.Messages.DocHandle_importErrorText2;
    public static String DocHandle_noPatientSelectedCaption = ch.elexis.core.l10n.Messages.DocHandle_noPatientSelectedCaption;
    ...
    public static String FileImportDialog_keywordsLabel = ch.elexis.core.l10n.Messages.FileImportDialog_keywordsLabel;
    public static String FileImportDialog_newCategoryCaption = ch.elexis.core.l10n.Messages.FileImportDialog_newCategoryCaption;
    ...
    public static String OmnivoreView_editActionTooltip = ch.elexis.core.l10n.Messages.OmnivoreView_editActionTooltip;
    public static String OmnivoreView_exportActionCaption = ch.elexis.core.l10n.Messages.OmnivoreView_exportActionCaption;
    public static String OmnivoreView_exportActionTooltip = ch.elexis.core.l10n.Messages.OmnivoreView_exportActionTooltip;
    ...
    public static String OmnivoreView_keywordsColumn = ch.elexis.core.l10n.Messages.OmnivoreView_keywordsColumn;
    public static String OmnivoreView_reallyDeleteCaption = ch.elexis.core.l10n.Messages.OmnivoreView_reallyDeleteCaption;
    public static String OmnivoreView_reallyDeleteContents = ch.elexis.core.l10n.Messages.OmnivoreView_reallyDeleteContents;
    public static String OmnivoreView_reallyDeleteTExt = ch.elexis.core.l10n.Messages.OmnivoreView_reallyDeleteTExt;
    public static String OmnivoreView_searchKeywordsLabel = ch.elexis.core.l10n.Messages.OmnivoreView_searchKeywordsLabel;
    ...
    public static String Preferences_cotf_dob = ch.elexis.core.l10n.Messages.Preferences_cotf_dob;

...
public class Messages extends NLS {
	...
	public static String UserDocboxPreferences_Password = ch.elexis.core.l10n.Messages.UserDocboxPreferences_Password;
	public static String UserDocboxPreferences_ConnectionTest = ch.elexis.core.l10n.Messages.UserDocboxPreferences_ConnectionTest;
	public static String UserDocboxPreferences_ConnectionTestWithDocbox = ch.elexis.core.l10n.Messages.UserDocboxPreferences_ConnectionTestWithDocbox;
	...
	public static String DocboxDocumentsView_Patient = ch.elexis.core.l10n.Messages.DocboxDocumentsView_Patient;
	public static String DocboxDocumentsView_DateSent = ch.elexis.core.l10n.Messages.DocboxDocumentsView_DateSent;
	public static String DocboxDocumentsView_Sender = ch.elexis.core.l10n.Messages.DocboxDocumentsView_Sender;
	public static String DocboxDocumentsView_Attachments = ch.elexis.core.l10n.Messages.DocboxDocumentsView_Attachments;
	...
	public static String DocboxDocumentsView_Action_Delete = ch.elexis.core.l10n.Messages.DocboxDocumentsView_Action_Delete;
	...
	public static String DocboxTerminvereinbarungAction_NoPatientSelectedText = ch.elexis.core.l10n.Messages.DocboxTerminvereinbarungAction_NoPatientSelectedText;
	...
	public static String DocboxTerminvereinbarungAction_NoDoctorSelectedText = ch.elexis.core.l10n.Messages.DocboxTerminvereinbarungAction_NoDoctorSelectedText;
	...
	public static String DocboxArztArztAction_NoPatientSelectedText = ch.elexis.core.l10n.Messages.DocboxArztArztAction_NoPatientSelectedText;
	...
	public static String DocboxArztArztAction_NoDoctorSelectedText = ch.elexis.core.l10n.Messages.DocboxArztArztAction_NoDoctorSelectedText;
	...
	public static String DocboxArztArztDialog_Title = ch.elexis.core.l10n.Messages.DocboxArztArztDialog_Title;
	public static String DocboxArztArztDialog_Message = ch.elexis.core.l10n.Messages.DocboxArztArztDialog_Message;
	public static String DocboxArztArztDialog_TextTitle = ch.elexis.core.l10n.Messages.DocboxArztArztDialog_TextTitle;
	public static String DocboxArztArztDialog_TextMessage = ch.elexis.core.l10n.Messages.DocboxArztArztDialog_TextMessage;
	public static String DocboxArztArztDialog_TextPatient = ch.elexis.core.l10n.Messages.DocboxArztArztDialog_TextPatient;
	public static String DocboxArztArztDialog_TextDoctor = ch.elexis.core.l10n.Messages.DocboxArztArztDialog_TextDoctor;
	public static String DocboxArztArztDialog_TextAttachments = ch.elexis.core.l10n.Messages.DocboxArztArztDialog_TextAttachments;

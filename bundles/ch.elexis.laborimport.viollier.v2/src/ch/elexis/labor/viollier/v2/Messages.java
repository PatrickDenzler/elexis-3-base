...
public class Messages extends NLS {
	...
	public static String LabOrderImport_ImportCompletedTitle = ch.elexis.core.l10n.Messages.LabOrderImport_ImportCompletedTitle;
	public static String LabOrderImport_ImportFromHL7 = ch.elexis.core.l10n.Messages.LabOrderImport_ImportFromHL7;
	...
	public static String LabOrderImport_titleImport = ch.elexis.core.l10n.Messages.LabOrderImport_titleImport;
	public static String LabOrderImport_SelectPatient = ch.elexis.core.l10n.Messages.LabOrderImport_SelectPatient;
	...
	public static String PatientLabor_DocumentLabItemName = ch.elexis.core.l10n.Messages.PatientLabor_DocumentLabItemName;
	...
	public static String PatientLabor_InfoExistingValueIsValid = ch.elexis.core.l10n.Messages.PatientLabor_InfoExistingValueIsValid;
	public static String PatientLabor_InfoNewerResultAlreadyExists = ch.elexis.core.l10n.Messages.PatientLabor_InfoNewerResultAlreadyExists;
	...
	public static String PatientLabor_nameDokumentLaborParameter = ch.elexis.core.l10n.Messages.PatientLabor_nameDokumentLaborParameter;
	public static String PatientLabor_nameViollierLabor = ch.elexis.core.l10n.Messages.PatientLabor_nameViollierLabor;
	public static String PatientLabor_TextForComments = ch.elexis.core.l10n.Messages.PatientLabor_TextForComments;
	...
	public static String Preferences_DirDownload = ch.elexis.core.l10n.Messages.Preferences_DirDownload;
	public static String Preferences_DirArchive = ch.elexis.core.l10n.Messages.Preferences_DirArchive;
	public static String Preferences_DirError = ch.elexis.core.l10n.Messages.Preferences_DirError;
	public static String Preferences_ArchivePurgeInterval = ch.elexis.core.l10n.Messages.Preferences_ArchivePurgeInterval;
	public static String Preferences_DocumentCategory = ch.elexis.core.l10n.Messages.Preferences_DocumentCategory;

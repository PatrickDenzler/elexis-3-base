...
public class Messages{
    ...
    public static String LabOrderImport_labelDownloadDir = ch.elexis.core.l10n.Messages.LabOrderImport_labelDownloadDir;
    ...
    public static String MedicsBrowserView_errorOpeningBrowserURL = ch.elexis.core.l10n.Messages.MedicsBrowserView_errorOpeningBrowserURL;
    ...
    public static String MedicsPreferencePage_labelArchivDir = ch.elexis.core.l10n.Messages.MedicsPreferencePage_labelArchivDir;
    public static String MedicsPreferencePage_labelDocumentCategory = ch.elexis.core.l10n.Messages.MedicsPreferencePage_labelDocumentCategory;
    public static String MedicsPreferencePage_labelDownloadDir = ch.elexis.core.l10n.Messages.MedicsPreferencePage_labelDownloadDir;
    public static String MedicsPreferencePage_labelErrorDir = ch.elexis.core.l10n.Messages.MedicsPreferencePage_labelErrorDir;
    public static String MedicsPreferencePage_labelUploadDir = ch.elexis.core.l10n.Messages.MedicsPreferencePage_labelUploadDir;

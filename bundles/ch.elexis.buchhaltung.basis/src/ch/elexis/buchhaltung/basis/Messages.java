...
public class Messages{
    ...
    public static String AlleLeistungen_Doctor = ch.elexis.core.l10n.Messages.AlleLeistungen_Doctor;
    public static String AlleLeistungen_InvoicingParty = ch.elexis.core.l10n.Messages.AlleLeistungen_InvoicingParty;
    public static String AlleLeistungen_Mandator = ch.elexis.core.l10n.Messages.AlleLeistungen_Mandator;
    ...
    public static String AlleLeistungen_User = ch.elexis.core.l10n.Messages.AlleLeistungen_User;
    ...
    public static String FakturaJournalDetail_Patient = ch.elexis.core.l10n.Messages.FakturaJournalDetail_Patient;
    ...
    public static String FakturaJournalDetail_Rechnungssteller = ch.elexis.core.l10n.Messages.FakturaJournalDetail_Rechnungssteller;
    public static String FakturaJournal_Amount = ch.elexis.core.l10n.Messages.FakturaJournal_Amount;
    public static String FakturaJournal_DatabaseQuery = ch.elexis.core.l10n.Messages.FakturaJournal_DatabaseQuery;
    ...
    public static String FakturaJournal_Text = ch.elexis.core.l10n.Messages.FakturaJournal_Text;
    ...
    public static String ListeNachFaelligkeit_AnalyzingBills = ch.elexis.core.l10n.Messages.ListeNachFaelligkeit_AnalyzingBills;
    ...
    public static String ListeNachFaelligkeit_DatabaseQuery = ch.elexis.core.l10n.Messages.ListeNachFaelligkeit_DatabaseQuery;
    public static String ListeNachFaelligkeit_Due = ch.elexis.core.l10n.Messages.ListeNachFaelligkeit_Due;
    public static String ListeNachFaelligkeit_PatientNr = ch.elexis.core.l10n.Messages.ListeNachFaelligkeit_PatientNr;
    public static String OffenePostenListe_AnalyzingBills = ch.elexis.core.l10n.Messages.OffenePostenListe_AnalyzingBills;
    ...
    public static String OffenePostenListe_DatabaseQuery = ch.elexis.core.l10n.Messages.OffenePostenListe_DatabaseQuery;
    public static String OffenePostenListe_Open = ch.elexis.core.l10n.Messages.OffenePostenListe_Open;
    public static String OffenePostenListe_OpenAmount = ch.elexis.core.l10n.Messages.OffenePostenListe_OpenAmount;
    public static String OffenePostenListe_OpenBillsPer = ch.elexis.core.l10n.Messages.OffenePostenListe_OpenBillsPer;
    public static String OffenePostenListe_PatientNr = ch.elexis.core.l10n.Messages.OffenePostenListe_PatientNr;
    ...
    public static String ZahlungsJournal_DatabaseQuery = ch.elexis.core.l10n.Messages.ZahlungsJournal_DatabaseQuery;
    public static String ZahlungsJournal_Date = ch.elexis.core.l10n.Messages.ZahlungsJournal_Date;
    public static String ZahlungsJournal_PatientNr = ch.elexis.core.l10n.Messages.ZahlungsJournal_PatientNr;
    ...
    public static String ZahlungsJournal_Text = ch.elexis.core.l10n.Messages.ZahlungsJournal_Text;

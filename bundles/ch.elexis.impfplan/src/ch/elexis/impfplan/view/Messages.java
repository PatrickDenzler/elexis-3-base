...
public class Messages{
    ...
    public static String AddVaccinationDialog_enterVaccinationTitle = ch.elexis.core.l10n.Messages.AddVaccinationDialog_enterVaccinationTitle;
    ...
    public static String EditVaccinationDialog_enterVaccination = ch.elexis.core.l10n.Messages.EditVaccinationDialog_enterVaccination;
    ...
    public static String EditVaccinationDialog_remarks = ch.elexis.core.l10n.Messages.EditVaccinationDialog_remarks;
    public static String EditVaccinationDialog_vaccinationSubstance = ch.elexis.core.l10n.Messages.EditVaccinationDialog_vaccinationSubstance;
    public static String ImpfplanPreferences_addCaption = ch.elexis.core.l10n.Messages.ImpfplanPreferences_addCaption;
    public static String ImpfplanPreferences_nameDummy = ch.elexis.core.l10n.Messages.ImpfplanPreferences_nameDummy;
    ...
    public static String ImpfplanPreferences_vaccDummy = ch.elexis.core.l10n.Messages.ImpfplanPreferences_vaccDummy;
    ...
    public static String ImpfplanPrinter_printPlanTitle = ch.elexis.core.l10n.Messages.ImpfplanPrinter_printPlanTitle;
    ...
    public static String ImpfplanPrinter_templateName = ch.elexis.core.l10n.Messages.ImpfplanPrinter_templateName;
    ...
    public static String ImpfplanPrinter_templateType = ch.elexis.core.l10n.Messages.ImpfplanPrinter_templateType;
    public static String ImpfplanView_dateColumn = ch.elexis.core.l10n.Messages.ImpfplanView_dateColumn;
    public static String ImpfplanView_printActionTitle = ch.elexis.core.l10n.Messages.ImpfplanView_printActionTitle;
    ...
    public static String ImpfplanView_vaccinationColumn = ch.elexis.core.l10n.Messages.ImpfplanView_vaccinationColumn;
